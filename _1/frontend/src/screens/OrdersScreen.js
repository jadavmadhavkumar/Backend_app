  ...
  const renderOrder = ({ item }) => (
    ...
    >
      <View style={styles.orderHeader}>
        <Image source={{ uri: item.restaurants.image }} style={styles.restaurantImage} />
        ...
        <View style={styles.orderStatus}>
          ...
          <Text style={styles.orderTotal}>${item.final_amount.toFixed(2)}</Text>
        </View>
      </View>
      ...
      <View style={styles.orderItems}>
        ...
        {item.order_items.length > 2 && <Text style={styles.moreItems}>+{item.order_items.length - 2} more items</Text>}
      </View>
