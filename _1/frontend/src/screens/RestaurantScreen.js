...
const RestaurantScreen = ({ route, navigation }) => {
  ...
  const fetchMenuData = async () => {
    try {
      // Fetch categories
      const categoriesResult = await restaurantService.getMenuCategories(restaurant.id)
      ...
      // Fetch initial menu
      const menuResult = await restaurantService.getMenuItems(restaurant.id)
  ...
  const fetchMenu = async () => {
    try {
      ...
      const result = await restaurantService.getMenuItems(restaurant.id, category)
    ...
    <View style={styles.menuItem}>
      ...
      <View style={styles.menuItemInfo}>
        <View style={styles.menuItemHeader}>
          ...
          {item.is_vegetarian && <Ionicons name="leaf" size={16} color="#4CAF50" />}
        </View>
        ...
        <View style={styles.restaurantHeader}>
          ...
          <View style={styles.restaurantMeta}>
            ...
            <View style={styles.metaItem}>
              ...
              <Text style={styles.metaText}>${restaurant.delivery_fee}</Text>
            </View>
          </View>
        </View>
